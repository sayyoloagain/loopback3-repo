...
module.exports = function (Realm) {
    _disableRemoteMethod(Realm)

    var __app;

    Realm.on('attached', function (a) {
        __app = a;
    });

    Realm.DeviceAddXox = async function (data, cb) {
        //     console.log(data);
        //   // console.log(cb);
        ...
        Realm.remoteMethod("deviceAddXox", {
    ...
    Realm.register = async function (data) {
        // console.log(data)
    ...
    Realm.updateInfo = async function (id, data) {
        // console.log(data)
    ...
    Realm.updateDevice = async function (id, body) {
        console.log(id)
        console.log(body)
        try {
    ...
    Realm.remoteMethod('updateDevice', {
    ...
    Realm.listDevice = function (cb) {
        __listDevice(__app, cb)   
    }
    Realm.remoteMethod('listDevice', {
    ...
    Realm.removeDevice = async function (id) {
        try {
    ...
    Realm.remoteMethod('removeDevice', {
